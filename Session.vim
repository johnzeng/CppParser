...
set shortmess=aoO
badd +152 ~/SimpleCompletor/header/Lex.h
...
badd +41 ~/SimpleCompletor/header/LexData.h
badd +20 ~/SimpleCompletor/Macro/MacroCheck.cpp
badd +91 ~/SimpleCompletor/header/GrammarUtil.h
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 153 - ((7 * winheight(0) + 9) / 18)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
153
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 1867 - ((4 * winheight(0) + 18) / 37)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
1867
